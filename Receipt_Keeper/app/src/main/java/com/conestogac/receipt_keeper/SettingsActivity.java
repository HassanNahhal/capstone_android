...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    final static String ACTION_PREFS_OCR = "com.conestogac.receipt_keeper.PREFS_OCR";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (action != null && action.equals(ACTION_PREFS_OCR)) {
            // Display the fragment as the main content.
            getFragmentManager().beginTransaction()
                    .replace(android.R.id.content, new OCRPreferenceFragment())
                    .commit();
            title = "OCR & Camera";
        } else {
            // Display the fragment as the main content.
    ...
    public static class SettingPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
           // bindPreferenceSummaryToValue(findPreference("preference_host_address"));
        }
    ...
    public static class OCRPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setHasOptionsMenu(true);
            bindPreferenceSummaryToValue(findPreference("preference_page_segmentation_mode"));
        }
